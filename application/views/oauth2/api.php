...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <form class="form-inline">
            <h1>0x01.Access Token获取的四种途径</h1><br>
            <div class="form-group">
                <label for="authorize">
                    <h3>第一种：授权码通过code获取access_token（Authorization Code）:</h3>
                    ...
                    <h4>注释：把本页url中返回的code值 填写在下方你调用的相应授权方式下 换取Access Token</h4><br><br>
            ...
            <br><br>
            <div class="form-group">
                <label for="Credentials"><h3>第二种：用户口令（Resource Owner Password Credentials）:</h3><br>
            ...
            <div class="form-group">
                <label for="ClientCredentials"><h3>第三种：应用授权（Client Credentials）:</h3><br>
...
$(document).ready(function(){
    ...
    $('#btn-authorize').click(function (e){
        var data = {code: $("#authorize-code").val(), client_id: 'testclient', client_secret:'testpass', redirect_uri:"http://oauth.local/oauth2/test", grant_type: 'authorization_code', scope:'userinfo'};
